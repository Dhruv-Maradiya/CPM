...
const create = (data) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const branch = yield prisma_1.default.branches.create({
                data: data,
            });
...
const update = (data, id) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const branches = yield prisma_1.default.branches.update({
                data: data,
                where: {
                    id: id,
                },
...
const find = (id) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (!branch) {
                throw new index_1.NotFoundError("branch not found");
            }
            return resolve(branch);
        }
        catch (error) {
