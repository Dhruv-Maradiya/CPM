...
const index_1 = __importDefault(require("../../controllers/academics/index"));
...
router.post("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const body = req.body;
        const academics = yield index_1.default.create(body);
        next(academics);
    }
    catch (error) {
        next(error);
...
router.put("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, utils_1.validateSchema)(index_2.default.update, req.body, false);
        const id = req.body.id;
        delete req.body.id;
        const body = req.body; // validation goes here
        const academics = yield index_1.default.update(body, id);
        next(academics);
    }
    catch (error) {
        next(error);
...
router.get("/find", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const academics = yield index_1.default.find(id);
        next(academics);
    }
    catch (error) {
        next(error);
...
router.get("/findMany", (_req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const academics = yield index_1.default.findMany();
        next(academics);
    }
    catch (error) {
        next(error);
