...
const index_1 = __importDefault(require("../../controllers/databaseTechnologies/index"));
...
router.post("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const body = req.body;
        const databaseTechnology = yield index_1.default.create(body);
...
router.put("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        delete req.body.id;
        const body = req.body;
        const databaseTechnology = yield index_1.default.update(body, id);
        next(databaseTechnology);
    }
    catch (error) {
        next(error);
...
router.get("/find", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const databaseTechnology = yield index_1.default.find(id);
        next(databaseTechnology);
    }
    catch (error) {
        next(error);
...
router.get("/findMany", (_req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const databaseTechnologies = yield index_1.default.findMany();
