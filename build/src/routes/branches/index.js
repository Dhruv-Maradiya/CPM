...
const index_1 = __importDefault(require("../../controllers/branches/index"));
...
router.post("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const body = req.body;
        const branch = yield index_1.default.create(body);
        next(branch);
    }
    catch (error) {
        next(error);
...
router.put("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        delete req.body.id;
        const body = req.body;
        const branch = yield index_1.default.update(body, id);
        next(branch);
    }
    catch (error) {
        next(error);
...
router.get("/find", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const branch = yield index_1.default.find(id);
        next(branch);
    }
    catch (error) {
        next(error);
...
router.get("/findMany", (_req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const branches = yield index_1.default.findMany();
        next(branches);
    }
    catch (error) {
        next(error);
