...
const index_1 = __importDefault(require("../../controllers/groups/index"));
...
router.post("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const body = req.body;
        const group = yield utils_1.prisma.$transaction((transaction) => __awaiter(void 0, void 0, void 0, function* () {
            const group = yield index_1.default.create(body, transaction);
            yield index_1.default.assignLeader(group.id, leaderId, transaction);
            return group;
        }));
        next(group);
    }
...
router.put("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        delete req.body.id;
        const body = req.body;
        const group = yield index_1.default.update(body, id, undefined);
        next(group);
    }
    catch (error) {
        next(error);
...
router.get("/find", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const group = yield index_1.default.find(id);
        next(group);
    }
    catch (error) {
        next(error);
...
router.get("/findMany", (_req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const groups = yield index_1.default.findMany();
        next(groups);
    }
    catch (error) {
        next(error);
