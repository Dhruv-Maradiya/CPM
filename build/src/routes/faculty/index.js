...
const index_1 = __importDefault(require("../../controllers/faculty/index"));
...
router.post("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const body = req.body;
        const faculty = yield index_1.default.create(body);
        next(faculty);
    }
    catch (error) {
        next(error);
...
router.put("/", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        delete req.body.id;
        const body = req.body;
        const faculty = yield index_1.default.update(body, id);
        next(faculty);
    }
    catch (error) {
        next(error);
...
router.get("/find", (req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const faculty = yield index_1.default.find(id);
        next(faculty);
    }
    catch (error) {
        next(error);
...
router.get("/findMany", (_req, _res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const faculties = yield index_1.default.findMany();
        next(faculties);
    }
    catch (error) {
        next(error);
